...
export function TabButton({ eventKey, disabled = false, className = '', children }) {
  ...
  const baseClasses = 'px-4 py-3 text-sm font-medium whitespace-nowrap transition-colors duration-200 border-b-2 -mb-px focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-inset';
